---
title: What is a cortisol spike?
...
But what is a cortisol spike, really? And does the science back up the panic? This guide is about the *definition* — what the term means and when a spike actually matters. If you're instead looking for the specific triggers, see our companion breakdown of [the 12 things that cause a cortisol spike](/blog/cortisol-spike-causes).
...
Some triggers are backed by evidence. Others are social media myths. Here's the short version — for the full, ranked rundown with how to recognize each one, see [12 things that cause a cortisol spike](/blog/cortisol-spike-causes).
