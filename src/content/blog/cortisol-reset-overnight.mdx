---
title: Can you reset cortisol overnight?
...
Cortisol follows a 24-hour rhythm called the circadian pattern. It drops to its lowest point around midnight, stays low for a few hours, then starts rising around 3-4 AM. By the time you wake up, it peaks—this is called the cortisol awakening response ([StatPearls: Physiology, Cortisol](https://www.ncbi.nlm.nih.gov/books/NBK538239/)).
...
Use the [free observation journal](/resources/stress-sleep-journal/) to keep notes about sleep and routine. It cannot estimate cortisol or decide whether testing is needed.

## Tracking observations without claiming a hormone result

A better night of sleep is an observation, not proof that cortisol normalized. A wearable record cannot verify a hormone reset.
