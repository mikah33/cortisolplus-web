---
title: "Welltory vs Cortisol+ stress tracker review"
description: "Welltory uses phone-camera spot HRV; Cortisol+ uses Apple Watch for continuous tracking. Side-by-side on accuracy, method, and pricing."
pubDate: 2026-05-23
...
**For cortisol estimation**: neither measures cortisol. Cortisol is a hormone quantified through blood or saliva testing, not by a phone camera or smartwatch ([StatPearls, *Physiology, Cortisol*](https://www.ncbi.nlm.nih.gov/books/NBK538239/)). Cortisol+ explicitly models cortisol patterns from multiple biometric correlates; Welltory presents a generic "stress" score that's HRV-derived. Both lean on the well-documented link between reduced heart rate variability and higher stress ([Kim et al., 2018](https://pubmed.ncbi.nlm.nih.gov/29486547/)). If the question is "what is my cortisol doing," Cortisol+ is the closer answer; if the question is "am I currently stressed," both work.
...
- Kim HG, Cheon EJ, Bai DS, Lee YH, Koo BH. *Stress and Heart Rate Variability: A Meta-Analysis and Review of the Literature.* Psychiatry Investigation, 2018. https://pubmed.ncbi.nlm.nih.gov/29486547/
