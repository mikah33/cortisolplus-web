...
1. **A lab cortisol test** — blood, saliva, or urine. The appropriate test, collection time and interpretation depend on the clinical question; there is no universal four-point screening panel for everyone. See [how to test cortisol](/cortisol/test).
...
3. **Biometric proxies** — HRV, resting heart rate, sleep and wrist temperature provide wearable context, but do not establish your cortisol curve. [Cortisol+](/how-it-works/) combines available signals into a wellness score; clinical accuracy against cortisol testing has not been established.

Clinical tests and wearable records answer different questions. A wearable history does not substitute for a clinician-selected cortisol test.
...
Cortisol+ organizes available wearable signals into a wellness score. A change in that score cannot prove an intervention changed cortisol. Read the [methodology](/how-it-works/) and discuss clinical testing or treatment questions with a healthcare professional.
