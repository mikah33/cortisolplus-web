...
4. **GA4:** verify an actual consented click reaches collection, register `app_store_click` as a key event, and create useful landing/source comparisons after real data exists. Keep synthetic QA traffic identified by `website-qa`.
